...
export default function FeaturedBookSpotlight({
  ...
  const bibleBook = {
    ...
    coverImage: '/techspec-digest/consciousness/images/bible_bedtime_stories_cover.jpg',
  ...
  const masterKeyBook = {
    ...
    coverImage: '/techspec-digest/consciousness/images/thinking_big_for_little_people.jpg',
  ...
  return (
    <section id="featured-book" className="max-w-7xl mx-auto mb-12 px-4 sm:px-6 lg:px-8 scroll-mt-28">
      <div className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-[#120D1F] via-[#0B0F19] to-[#1A1208] border border-amber-500/35 shadow-2xl shadow-black/80">
        {/* Ambient Glow Orbs */}
        ...
        <div className="relative z-10 p-6 sm:p-10 lg:p-12">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-amber-500/20 pb-6 mb-8">
            <div className="space-y-1">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-500/15 border border-amber-500/30 text-amber-300 text-xs font-bold uppercase tracking-wider">
                ...
                <span>Featured Essential Literature • Bedtime &amp; Mindset Collection</span>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            {/* Right Column: Compelling Breakdown & Wisdom Pillars */}
